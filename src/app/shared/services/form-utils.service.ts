...
import { UntypedFormBuilder, UntypedFormGroup, FormGroup, UntypedFormControl, UntypedFormArray, ControlEvent } from '@angular/forms';
...
export class FormUtilsService {
  ...
  getFormArrayFieldErrorMessage(
    ...
    const field = formArray.at(index).get(fieldName) as UntypedFormControl; // aqui está diferente
    return this.getErrorMessageFromField(field);
  }
